...
contract FEG is Context, IERC20, Ownable {
    ...
    function workingSupply() public view returns(uint256){
        uint256 temp = _rTotal - reflectionFromToken(_tFeeTotal,false);
        return tokenFromReflection(temp);
    }
    ...
    function _getTValues(uint256 tAmount) public view returns (uint256, uint256) {
        uint256 tFee = tAmount.div(10).mul(2);
